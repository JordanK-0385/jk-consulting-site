...
const VUES = {
  ...
  liaison:  { ancre:'#liaison .stage', marge:0, scroll:1,
              paires:[['.benefit-tl','#liaison-title'],['.benefit-tr','#liaison-title'],
                      ['.benefit-bl','#liaison-title'],['.benefit-br','#liaison-title'],
                      ['.benefit-tl','.benefit-bl'],['.benefit-tr','.benefit-br'],
                      ['.benefit-tl','.benefit-tr'],['.benefit-bl','#liaison .cue']] },
